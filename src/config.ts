...
class Config {
	...
	constructor(repo?: string) {
		this.config = vscode.workspace.getConfiguration('review-graph', repo ? vscode.Uri.file(repo) : undefined);
	}
	...
	/**
	 * Get the value of the `review-graph.contextMenuActionsVisibility` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.customBranchGlobPatterns` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.customEmojiShortcodeMappings` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.gerrit.*` Extension Settings.
	 */
	...
	/**
	 * Get the value of the `review-graph.defaultColumnVisibility` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.dialog.*` Extension Settings.
	 */
	...
	/**
	 * Get the value of the `review-graph.dialog.merge.squashMessageFormat` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.dialog.pullBranch.squashMessageFormat` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.enhancedAccessibility` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.fileEncoding` Extension Setting.
	 */
	get fileEncoding() {
	...
	/**
	 * Get the value of the `review-graph.integratedTerminalShell` Extension Setting.
	 */
	...
	/**
	 * Get the keybinding configuration from the `review-graph.keyboardShortcut.*` Extension Settings.
	 */
	...
	/**
	 * Get the value of the `review-graph.maxDepthOfRepoSearch` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.markdown` Extension Setting.
	 */
	get markdown() {
	...
	/**
	 * Get the value of the `review-graph.openToTheRepoOfTheActiveTextEditorDocument` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.repository.fetchAndPruneTags` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.repository.trackRemoteTags` Extension Setting.
	 */
	get trackRemoteTags() {
	...
	/**
	 * Get the value of the `review-graph.repository.showRemoteBranches` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.repository.showRemoteHeads` Extension Setting.
	 */
	get showRemoteHeads() {
	...
	/**
	 * Get the value of the `review-graph.repository.commits.showBodyInline` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.repository.showStashes` Extension Setting.
	 */
	get showStashes() {
	...
	/**
	 * Get the value of the `review-graph.repository.sign.commits` Extension Setting.
	 */
	get signCommits() {
	...
	/**
	 * Get the value of the `review-graph.repository.sign.tags` Extension Setting.
	 */
	get signTags() {
	...
	/**
	 * Get the value of the `review-graph.repository.extDiffToolArgs` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.repositoryDropdownOrder` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.retainContextWhenHidden` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.showStatusBarItem` Extension Setting.
	 */
	...
	/**
	 * Get the value of the `review-graph.stickyHeader` Extension Setting.
	 */
	get stickyHeader() {
	...
	/**
	 * Get the value of the `review-graph.tabIconColourTheme` Extension Setting.
	 */
	 ...
	 * `review-graph.avatars.gitlabToken` Extension Setting, used to raise the rate limit of the
